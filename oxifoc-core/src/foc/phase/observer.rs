...
impl BackEmfObserver {
    ...
    pub fn update(&mut self, input: &ObserverInput) {
        ...
        // (An eddy-current L(f) ladder used to add a ΔL·Δi_f term here; it
        // was deleted 2026-07-07 after the pulsating-carrier A/B proved the
        // ZD2808 winding is flat ~17 µH — the apparent L(f) rise was rotor
        // motion. See docs/decisions.md "minimal load-bearing set".)
    ...
    ///
    /// Guards the slow coherent phantom (bench 2026-07-07,
    /// captures/slipgate-1,2) — currents
