...
/// filter; 3168 for its low-passed pull error (delta_filt) — still three
/// ~1030 B grants in flight (2048 = 1-2 grants stalled the 20 kHz
/// stream, 2026-07-05); frees 800 B toward fitting the statics into the
/// 22 K SRAM region.)
pub const OUT_QUEUE_SIZE: usize = 3168;
