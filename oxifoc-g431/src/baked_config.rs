...
pub fn baked() -> RuntimeConfig {
    RuntimeConfig {
        ...
        motor_params: Some(MotorParamsConfig {
            ...
            // (The eddy L(f) ladder fields were deleted 2026-07-07: the
            // pulsating-carrier sweep proved the apparent ΔL 146 µH was the
            // ROTOR swinging on the hold-current spring — the true d-axis L
            // is FLAT ~17 µH to 100 kHz. See docs/decisions.md.)
        }),
